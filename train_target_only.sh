...
cd $EXP_NAME
# ln -s /data/yzhang/video-project/pretrained .


BATCH_SIZE=8
CUDA_VISIBLE_DEVICES=$GPUs python train_target_only.py --snapshot-dir ./snapshots/ue2diva \
    --train-list /data/wxy/diva_i3d/name_lists/training.txt \
    ...
    --num-steps-stop 20000 --save-pred-every 100 \
